    ...
    <section className="section" id="places" data-screen-label="04 Places">
      <div className="container">
        ...
        <div className="places reveal">
          {places.map((p) => (
            <a key={p.name} className="place" href={ZILLOW_LINKS[p.slug]} target="_blank" rel="noopener">
...
function Wizard({ mode = "inline", onClose }) {
  ...
  const next = async () => {
    ...
    if (isLast) {
      // Open Calendly in a new tab and show the thank-you screen
      window.open("https://calendly.com/coasthomes/discoverycall", "_blank", "noopener");
          ...
          <div className="wizard__form reveal">
            ...
            {!done ? (
              <>
                ...
                <div className="wizard__nav">
                  ...
                  <button
                    ...
                    disabled={!canAdvance}
                  >
                    {isLast ? "Book a 15-min call →" : "Continue"} <Icon.arrow />
                  </button>
              ...
              <div className="wizard__done">
                ...
                <h3>Great — let's find a time to talk.</h3>
                <p>
                  I just opened my calendar in a new tab. Pick the slot that
                  works best and you'll get a confirmation right away. If the
                  tab didn't open, <a href="https://calendly.com/coasthomes/discoverycall" target="_blank" rel="noopener">click here</a>.
                </p>
                <div className="echo">
    ...
    <section className="section" id="blog" data-screen-label="07 Blog">
      <div className="container">
        ...
        <div className="blog-allcta">
          <a className="btn btn--ghost" href="#top">Back to top <Icon.arrow /></a>
        </div>
      </div>
    </section>
  );
